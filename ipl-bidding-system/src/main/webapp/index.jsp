    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card shadow text-center">
                <img src="https://english.cdn.zeenews.com/sites/default/files/2025/12/14/1876894-ipl-auction-venues.jpg"
                     height="350" class="card-img-top">

                <div class="card-body">
                    <h5 class="card-title">Register New Player</h5>
                    <p class="card-text">
                        Add IPL players to the bidding system.
                    </p>
